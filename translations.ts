...
export const TRANSLATIONS = {
  en: {
    ...
    emailHistorySub: "Persistent log of booking verification emails sent by SmartRoom.",
  ...
  th: {
    ...
    emailHistorySub: "บันทึกถาวรของอีเมลยืนยันการจองที่ส่งออกจากระบบ SmartRoom",
